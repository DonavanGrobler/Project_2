...
var actions_resize_ScaleAction = require('./resize/ScaleAction.cjs');
...
function scale(width, height) {
    return new actions_resize_ScaleAction.ScaleAction('scale', width, height);
}
/**
 * @summary action
 * @description
...
function imaggaScale(width, height) {
    return new actions_resize_ResizeSimpleAction('imagga_scale', width, height);
}
/**
 * @summary action
 * @description
...
function imaggaCrop(width, height) {
    return new actions_resize_ResizeSimpleAction('imagga_crop', width, height);
}
/**
 * @summary action
...
function crop(width, height) {
    return new actions_resize_ResizeCropAction('crop', width, height);
}
/**
 * @summary action
 * @description
...
function fit(width, height) {
    return new actions_resize_ResizeSimpleAction('fit', width, height);
}
/**
 * @summary action
 * @description
...
function pad(width, height) {
    return new actions_resize_ResizePadAction('pad', width, height);
}
/**
 * @summary action
 * @description
...
function limitFill(width, height) {
    return new actions_resize_ResizeFillAction.ResizeFillAction('lfill', width, height);
}
/**
 * @summary action
 * @description
...
function limitFit(width, height) {
    return new actions_resize_ResizeSimpleAction('limit', width, height);
}
/**
 * @summary action
 * @description
...
function minimumPad(width, height) {
    return new actions_resize_ResizePadAction('mpad', width, height);
}
/**
 * @summary action
 * @description
...
function minimumFit(width, height) {
    return new actions_resize_ResizeSimpleAction('mfit', width, height);
}
/**
 * @summary action
 * @memberOf Actions.Resize
...
function fillPad(width, height) {
    return new actions_resize_ResizePadAction('fill_pad', width, height);
}
/**
 * @summary action
 * @description
...
function limitPad(width, height) {
    return new actions_resize_ResizePadAction('lpad', width, height);
}
var Resize = {
