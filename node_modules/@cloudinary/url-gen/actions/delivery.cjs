...
var actions_delivery_DeliveryFormat = require('./delivery/DeliveryFormat.cjs');
var actions_delivery_DeliveryQuality = require('./delivery/DeliveryQuality.cjs');
var internal_utils_toFloatAsString = require('../internal/utils/toFloatAsString.cjs');
var actions_delivery_DeliveryColorSpaceFromICC = require('./delivery/DeliveryColorSpaceFromICC.cjs');
...
function format(format) {
    return new actions_delivery_DeliveryFormat.DeliveryFormat('f', format);
}
/**
 * @summary action
...
function dpr(dpr) {
    ...
    return new actions_delivery_DeliveryAction.DeliveryAction('dpr', internal_utils_toFloatAsString.toFloatAsString(dpr));
}
/**
 * @summary action
...
function quality(qualityType) {
    return new actions_delivery_DeliveryQuality.DeliveryQualityAction(qualityType);
}
/**
 * @summary action
...
function density(value) {
    return new actions_delivery_DeliveryAction.DeliveryAction('dn', value);
}
/**
 * @summary action
...
function defaultImage(publicIdWithExtension) {
    return new actions_delivery_DeliveryAction.DeliveryAction('d', publicIdWithExtension);
}
/**
 * @summary action
...
function colorSpace(mode) {
    return new actions_delivery_DeliveryAction.DeliveryAction('cs', mode);
}
/**
 * @summary action
...
function colorSpaceFromICC(publicId) {
    return new actions_delivery_DeliveryColorSpaceFromICC.DeliveryColorSpaceFromICC(publicId);
}
var Delivery = {
    format: format,
    dpr: dpr,
