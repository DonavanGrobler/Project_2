...
var actions_delivery_DeliveryFormat = require('../actions/delivery/DeliveryFormat.cjs');
...
var CloudinaryTransformable = /** @class */ (function (_super) {
    ...
    CloudinaryTransformable.prototype.quality = function (quality) {
        this.addAction(new actions_delivery_DeliveryFormat.DeliveryFormat('q', quality));
        return this;
    };
    /**
    ...
    CloudinaryTransformable.prototype.format = function (format) {
        this.addAction(new actions_delivery_DeliveryFormat.DeliveryFormat('f', format));
        return this;
    };
    /**
     * @desc A proxy to {@link SDK.Transformation| Transformation} - Calls the same method contained in this.transformation
